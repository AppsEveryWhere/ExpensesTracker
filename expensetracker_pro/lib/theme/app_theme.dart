...
/// Trusted Depth Palette optimized for mobile expense tracking.
class AppTheme {
  AppTheme._();

  // Primary color palette based on Trusted Depth Palette
  static const Color primaryLight = Color(0xFF1B365D); // Deep trustworthy blue
  ...
  static const Color accentColor = Color(0xFFFF6B35); // Warm orange for alerts

  // Surface colors optimized for mobile viewing
  static const Color surfaceLight = Color(0xFFFAFAFA); // Light mode background
  static const Color surfaceDark = Color(0xFF121212); // True dark mode surface
  static const Color cardLight = Color(0xFFFFFFFF);
  static const Color cardDark = Color(0xFF1E1E1E);

  // Text colors with high contrast for mobile accessibility
  static const Color textPrimaryLight = Color(0xFF1C1C1E);
  static const Color textPrimaryDark = Color(0xFFFFFFFF);
  static const Color textSecondaryLight = Color(0xFF6C6C70);
  static const Color textSecondaryDark = Color(0xFFB3B3B3);

  // Status colors for financial feedback
  static const Color errorColor = Color(0xFFDC3545); // Clear error indication
  static const Color warningColor =
      Color(0xFFFFC107); // Budget threshold alerts
  static const Color successColor =
      Color(0xFF28A745); // Positive financial feedback

  // Divider and border colors with subtle opacity
  static const Color dividerLight =
      Color(0x0D000000); // 0.5px opacity equivalent
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Card theme with subtle elevation for expense items
    cardTheme: CardTheme(
      color: cardLight,
      elevation: 1,
    ...
    // Bottom navigation optimized for mobile financial apps
    ...
    // FAB theme for quick expense entry
    ...
    // Input decoration for expense entry forms
    ...
    // Slider theme for budget settings
    ...
    // SnackBar theme for financial notifications
    ...
    // List tile theme for expense items
    ...
    // Expansion tile theme for grouping
  ...
  /// Optimized for mobile readability and financial data scanning
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      // Display styles for large financial amounts
      ...
      // Title styles for expense categories and cards
  ...
  /// Monospace text style for financial data display
